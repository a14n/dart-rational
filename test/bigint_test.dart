...
main() {
  ...
  test('operator +(BigInt other)', () {
    ...
    expect((p('-1') + p('2')).toString(), equals('1'));
    expect((p('-1') + p('-2')).toString(), equals('-3'));
    expect((p('31878018903828899277492024491376690701584023926880') + p('1'))
            .toString(),
        equals('31878018903828899277492024491376690701584023926881'));
    expect((p('10000000000000000000000000000000000000000000000000') +
            p('10000000000000000000000000000000000000000000000000')).toString(),
  ...
  test('operator -(BigInt other)', () {
    ...
    expect((p('10000000000000000000000000000000000000000000000000') -
            p('1000000000000000000000000000000000000000000000000')).toString(),
    ...
    for (int i = -10; i < 10; i++) {
      for (int j = -10; j < 10; j++) {
        ...
        expect((p(i.toString()) % p(j.toString())).toString(),
            equals((i % j).toString()), reason: "$i % $j");
      }
    }
